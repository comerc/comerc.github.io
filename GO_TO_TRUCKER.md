...
Это пятничный пост, фантазия на тему. Илон Маск как-то говорил, что необязательно всю жизнь сидеть кодером. Но мечта должна оставаться мечтой, иначе мечты не будет. И всё же, я взялся исследовать свою давнюю мечту и вот что получилось.
